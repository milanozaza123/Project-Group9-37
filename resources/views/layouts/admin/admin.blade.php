    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('product_typeform')}}" class="nav-link">
                <i class="nav-icon fas fa-cart-plus"></i>
              <p>
                Category
...
<!-- เกี่ยวกับ Form -->
<script src="{{asset('admin/plugins/bs-custom-file-input/bs-custom-file-input.min.jsplugins/bs-custom-file-input/bs-custom-file-input.min.js')}}"></script>
<script>
  $(function () {
